...
namespace Mcd.HospitalManagement.Web.Enums
{
    ...
    public enum PatientMedicalTestError
    {
        ...
        [EnumStringAttribute("This Medical Test already Exists for this patient")]
        AlreadyExistMedicalTest = 1,

        [EnumStringAttribute("Not exists Medical Test for patients")]
        ExistsPatientMedicalTest=2,

        [EnumStringAttribute("Can't Delete. Medical Test is used for medical Test Allocation")]
        ExistsMedicalTestInMedicalAllocation = 3,

        [EnumStringAttribute("Can't Delete. Nurse is used for medical Test Allocation")]
        ExistsNurseInMedicalAllocation = 4,
    }
    /// <summary>
