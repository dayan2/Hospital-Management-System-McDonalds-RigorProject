...
namespace Mcd.HospitalManagement.Web.Controllers
{
    public class PatientMedicalTestsController : BaseController
    {
        ...
        /// </summary>
        /// <param name="patientDetailsId">int type</param>
        ...
        public ActionResult Create(int patientDetailsId, int medicalTestId, int nurseId)
        {
            ...
            if (ModelState.IsValid)// check model validation
            {
                ...
                if (!dbMedicalTestAllocation.CheckExistsMedicalTestForPatientAdmission(patientDto))
                {
                    ...
                    return Json(new { Message = CustomEnumMessage.GetStringValue(PatientMedicalTestError.AlreadyExistMedicalTest) });
                }
        ...
        /// </summary>
        /// <returns>View ViewPatientMedicalTest</returns>
        ...
        /// <returns>returns Json result in Edit view</returns>
        [HttpPost]
        ...
        public ActionResult Delete(int? id)
        {
             ...
             (UserRoleEnum)Enum.Parse(typeof(UserRoleEnum), Session["USERROLE"].ToString()) == UserRoleEnum.Cashier)
            {
                ...
                if (!dbMedicalTestAllocation.ExistsPatientMedicalTest((int)id))
                    return RedirectToAction(ERROR_TYPE, ERROR_MSG, new { ErrorMessage = CustomEnumMessage.GetStringValue(PatientMedicalTestError.ExistsPatientMedicalTest) });
        ...
        /// <returns> PatientMedicalTest Patial view</returns>
        [HttpPost]
