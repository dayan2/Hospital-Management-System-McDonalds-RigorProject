...
namespace Mcd.HospitaManagementSystem.Business
{
    public class PatientMedicalTestAllocation : IPatientMedicalTestAllocation
    {
        ...
        /// </summary>
        /// <param name="patientMedicalTestDTO">PatientMedicalTestDTO</param>
        ...
        /// </summary>
        /// <returns>IEnumerable PatientMedicalTestDTO list</returns>
        ...
        /// </summary>
        /// <param name="patientMedicalTestId">int? type</param>
        /// <returns>PatientMedicalTestDTO</returns>
        ...
        /// <returns>IEnumerable PatientDTO list</returns>
        ...
        /// </summary>
        /// <param name="id">PatientMedicalTestId</param>
        /// <returns>bool</returns>
        ...
        /// <summary>
        /// check Exits Nurse In Medical Test Allocation. If exits, return true
        /// </summary>
        /// <param name="NurseId">int type</param>
        /// <returns>bool value</returns>
        public bool ExitsNurseInMedicalAllocation(int NurseId)
        {
            ...
            try
            {
                using (var db = new LP_HMSDbEntities())
                {
                    ...
                    if (!db.PatientMedicalTests.Any(x => x.NurseId == NurseId))
                        return false;
                }
            }
            catch (Exception)
        ...
        /// <summary>
        /// check Exits Medical In Medical Test Allocation. If exits, return true
        /// </summary>
        /// <param name="MedicalTestId">int type</param>
        /// <returns>bool value</returns>
        public bool ExitsMedicalInMedicalAllocation(int MedicalTestId)
        {
            ...
            try
            {
                using (var db = new LP_HMSDbEntities())
                {
                    if (!db.PatientMedicalTests.Any(x => x.MedicalTestId == MedicalTestId))
                        return false;
                }
            }
            catch (Exception)
