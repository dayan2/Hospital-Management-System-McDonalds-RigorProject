...
{   
    ...
    public class DoctorRecommendationDetails
    {
        ...
        /// <summary>
        /// Get all DoctorRecommendations and send it to the controller
        /// </summary>
        ...
        public bool SaveTransferDoctorDetails(DoctorRecommendationDTO doctor)
        {
            try
            {
                using (var hmsDbContext = new LP_HMSDbEntities())
                {
                    ...
                    DoctorRecomendation doctorEntity = new DoctorRecomendation
                    {
                        Id = doctor.Id,
                    ...
                    hmsDbContext.DoctorRecomendations.Add(doctorEntity);
        ...
        /// <summary>
        /// Removing DoctorRecommendation Details from DB
        /// </summary>
