...
namespace Mcd.HospitaManagementSystem.Business
{
    public interface IPatientManager
    {
        ...
        bool CheckRelationshipBetweenPatientDetailsAndInvoice(int? detailId);

        bool CheckRelationshipBetweenPatientDetailsAndpatientFeedback(int? detailId);

        bool CheckRelationshipBetweenPatientDetailsAndpatientMediaclTest(int? detailId);
