...
namespace Mcd.HospitalManagement.Web.Controllers
{
    ...
    public class NursesController : BaseController
    {
        ...
        INurse dbNurse;
        IWards dbWard;
        IPatientMedicalTestAllocation dbPatientMedical;
        ...
        public ActionResult Delete(int? id)
        {
            ...
            if ((UserRoleEnum)Enum.Parse(typeof(UserRoleEnum), Session["USERROLE"].ToString()) == UserRoleEnum.Admin)
            {
                ...
                if (dbPatientMedical.ExitsNurseInMedicalAllocation((int)id))
                {
                    return RedirectToAction(ERROR_TYPE, ERROR_MSG, new { ErrorMessage = CustomEnumMessage.GetStringValue(PatientMedicalTestError.ExistsNurseInMedicalAllocation) });
                }
